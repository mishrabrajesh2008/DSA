...
public class Binary2Decimal {
    ...
    public Binary2Decimal(int value) {
    ...
    public int binaryToDecimal() {
		...
		Node temp = head;
		while(temp!=null) {
			result = (int) (result + (temp.value)*(Math.pow(2, length-1)));
			temp = temp.next;
			length--;
		}
		return result;
	}
    public int binaryToDecimal1() {
    	int num=0;
    	Node current = head;
    	while(current!=null) {
    ...
    public static void main(String[] args) {
    	Binary2Decimal b2d = new Binary2Decimal(1);
    	b2d.append(0);
    	b2d.append(1);
    	b2d.append(1);
    	
    	System.out.println("Converted value is: "+b2d.binaryToDecimal());
    	System.out.println("Converted value is: "+b2d.binaryToDecimal1());
	}
